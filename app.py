...
# # from services.openai_service import generate_subtasks, translate_task
...
# st.title("AI-Powered To-Do Application")
# init_db()
...
#     st.subheader(f"Task #{task_id}: {task_text}")
#     st.write("Subtasks:")
...
#     # Completion
#     if not completed and st.button(f"Mark Task #{task_id} as Complete"):
#         mark_task_complete(task_id)
#         st.rerun()

#     # Translation
#     lang_input = st.text_input(f"Translate Task #{task_id} to:")
#     if st.button(f"Translate Task #{task_id}"):
#         if lang_input:
#             translated = translate_task(task_text, lang_input)
#             update_translation(task_id, translated, lang_input)
#             st.success(f"Task translated to {lang_input}")
#             st.rerun()
#         else:
